            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/about' . '/' . $about->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Photo </th><td> {{ $about->photo }} </td></tr><tr><th> Desc </th><td> {{ $about->desc }} </td></tr>
                                </tbody>
                            </table>
                        </div>
